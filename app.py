...
FINE_TUNED_MODEL = "ftjob-Kq2k2xKL44WKboVl5bcx0MLA"  # ID del modelo afinado en OpenAI
...
# Función para seleccionar una textura aleatoriamente en el caso de "artisticos" y "blancos"
...
# Función para aplicar múltiples filtros y una textura a la imagen de fondo generada
